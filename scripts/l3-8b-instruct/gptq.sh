...
for wbits in "${WBITS_VALUES[@]}"; do
  ...
  for seed in "${SEEDS[@]}"; do
    ...
    LOG_FILE="/work/10322/scha0901/vista/FOEM/LLM/weight-only/logs/l3-8b-instruct/${DATE}_l3-8b-instruct-${wbits}bit-128g_gptq_seed${seed}.log"
