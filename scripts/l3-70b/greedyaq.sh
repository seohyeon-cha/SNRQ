...
BASE_PLOT_PATH="plots/alpha/l3-70b/3bits_g128_sample"
...
for wbits in "${WBITS_VALUES[@]}"; do
  ...
  for seed in "${SEEDS[@]}"; do
    ...
    LOG_FILE="/work/10322/scha0901/vista/FOEM/LLM/weight-only/logs/l3-70b/${DATE}_l3-70b-${wbits}bit-128g_greedyaq_seed${seed}.log"
