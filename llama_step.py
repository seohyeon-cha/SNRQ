        ...
        for names in sequential:
            ...
            for name in subset:
                ...
                if args.method == "greedyaq":
                    ...
                    scale, zero, g_idx, error = gptq[name].fasterquant(percdamp=args.percdamp, groupsize=args.groupsize, actorder=args.act_order, name=name, alpha=args.alpha, beta=args.beta)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha-method', type=str, default='fixed', choices=['fixed', 'alternate'], help='Method to use for alpha update.')
